...
from db import get_verses_by_surah_num, get_verses_by_juz_num, get_verses_by_hizb_num, get_verses_by_page_num, get_surahs, get_surah_by_id
...
def tab_juz(juz_num):
    return render_template("tab_categories/juz.html", category_num=juz_num, category="juz", verses = get_verses_by_juz_num(juz_num))
...
def tab_surah(surah_num):
    ...
    return render_template("tab_categories/surah.html", category_num=surah_num, category="surah", verses = get_surah_by_id(surah_num))

@app.route("/hizb/<int:hizb_num>")
def tab_hizb(hizb_num):
    return render_template("tab_categories/hizb.html", category_num=hizb_num, category="hizb", verses = get_verses_by_hizb_num(hizb_num))


@app.route("/page/<int:page_num>")
def tab_page(page_num):
    return render_template("tab_categories/page.html", category_num=page_num, category="page", verses = get_verses_by_page_num(page_num))
